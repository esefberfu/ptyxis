...
#define PTYXIS_SETTING_KEY_SINGLE_WINDOW_MODE      "single-window-mode"
...
gboolean                ptyxis_settings_get_single_window_mode      (PtyxisSettings             *self);
void                    ptyxis_settings_set_single_window_mode      (PtyxisSettings             *self,
